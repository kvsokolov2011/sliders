...
@section('admin')
    @can("viewAny", \App\Slide::class)
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route("admin.slides.update", ["slide" => $slide]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("put")
                        ...
                        <div class="form-group">
                            ...
                            <input type="date"
                                   id="published_at"
                                   name="published_at"
                                   value="{{ old('published_at', $slide->published_at) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date"
                                   id="unpublished_at"
                                   name="unpublished_at"
                                   value="{{ old('unpublished_at', $slide->unpublished_at) }}"
